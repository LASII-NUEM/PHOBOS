...
#minimizer arguments
models = ["Longo2020", "Zurich2021", "Zhang2024", "Yang2025"]
plt.figure()
subplot_counter = 1
for model in models:
    ...
    #plot
    #fig, ax = plt.subplots()
    plt.subplot(1,len(models), subplot_counter)
    plt.title(model)
    ax = plt.gca()
    leg = []
    ...
    subplot_counter += 1 #update the plot counter
