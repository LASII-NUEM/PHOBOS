...
Z_exp1 = fitting_utils.Fouquet2005(params, [omegas, scaling]) #complex impedance
Z_exp1 = Z_exp1.astype("complex")

#Exp3
params = [0.00406, 0.0123, 1.080, 0.8, 0.0094, 0.0818]
Z_exp3 = fitting_utils.Fouquet2005(params, [omegas, scaling]) #complex impedance
Z_exp3 = Z_exp3.astype("complex")

#Exp5
params = [0.004, 0.0147, 1.102, 0.8, 0.0172, 0.0784]
Z_exp5 = fitting_utils.Fouquet2005(params, [omegas, scaling]) #complex impedance
Z_exp5 = Z_exp5.astype("complex")

#Exp12
params = [0.00416, 0.0163, 0.936, 0.8, 0.0312, 0.0947]
Z_exp12 = fitting_utils.Fouquet2005(params, [omegas, scaling]) #complex impedance
