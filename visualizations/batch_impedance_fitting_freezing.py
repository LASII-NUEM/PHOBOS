...
#see: ../impedance_fitting/batch_fit_selected_models.py to generate the required .pkl file
...
longo_nmse = axs[0,1].plot(spec_ice_obj.human_timestamps[0], longo_NMSE[0])[0]
axs[0,1].grid()
axs[0,1].set_xlabel("Timestamp")
axs[0,1].set_title("NMSE")
longo_chi = axs[0,2].plot(spec_ice_obj.human_timestamps[0], longo_chi_square[0])[0]
axs[0,2].grid()
...
axs[1,0].legend()
axs[1,0].grid()
axs[1,0].set_title("Nyquist plot")
axs[1,0].set_xlabel("Z'")
axs[1,0].set_ylabel("Z''")
zurich_nmse = axs[1,1].plot(spec_ice_obj.human_timestamps[0], zurich_NMSE[0])[0]
axs[1,1].grid()
axs[1,1].set_xlabel("Timestamp")
zurich_chi = axs[1,2].plot(spec_ice_obj.human_timestamps[0], zurich_chi_square[0])[0]
axs[1,2].grid()
...
axs[2,0].legend()
axs[2,0].grid()
axs[2,0].set_title("Nyquist plot")
axs[2,0].set_xlabel("Z'")
axs[2,0].set_ylabel("Z''")
zhang_nmse = axs[2,1].plot(spec_ice_obj.human_timestamps[0], zhang_NMSE[0])[0]
axs[2,1].grid()
axs[2,1].set_xlabel("Timestamp")
zhang_chi = axs[2,2].plot(spec_ice_obj.human_timestamps[0], zhang_chi_square[0])[0]
axs[2,2].grid()
...
axs[3,0].legend()
axs[3,0].grid()
axs[3,0].set_title("Nyquist plot'")
axs[3,0].set_xlabel("Z'")
axs[3,0].set_ylabel("Z''")
yang_nmse = axs[3,1].plot(spec_ice_obj.human_timestamps[0], yang_NMSE[0])[0]
axs[3,1].grid()
axs[3,1].set_xlabel("Timestamp")
yang_chi = axs[3,2].plot(spec_ice_obj.human_timestamps[0], yang_chi_square[0])[0]
axs[3,2].grid()
...
axs[4,0].legend()
axs[4,0].grid()
axs[4,0].set_title("Nyquist plot")
axs[4,0].set_xlabel("Z'")
axs[4,0].set_ylabel("Z''")
fouquet_nmse = axs[4,1].plot(spec_ice_obj.human_timestamps[0], fouquet_NMSE[0])[0]
axs[4,1].grid()
axs[4,1].set_xlabel("Timestamp")
fouquet_chi = axs[4,2].plot(spec_ice_obj.human_timestamps[0], fouquet_chi_square[0])[0]
axs[4,2].grid()
...
axs[5,0].legend()
axs[5,0].grid()
axs[5,0].set_title("Nyquist plot")
axs[5,0].set_xlabel("Z'")
axs[5,0].set_ylabel("Z''")
awayssa_nmse = axs[5,1].plot(spec_ice_obj.human_timestamps[0], awayssa_NMSE[0])[0]
axs[5,1].grid()
axs[5,1].set_xlabel("Timestamp")
awayssa_chi = axs[5,2].plot(spec_ice_obj.human_timestamps[0], awayssa_chi_square[0])[0]
axs[5,2].grid()
...
def update_nyquist(frame):
    ...
    if frame-window < 0:
        window = 0
    fig.suptitle(f'timestamp = {spec_ice_obj.human_timestamps[frame]}')
    ...
    longo_nmse.set_xdata(spec_ice_obj.human_timestamps[:frame+1])
    longo_nmse.set_ydata(longo_NMSE[:frame+1])
    longo_chi.set_xdata(spec_ice_obj.human_timestamps[:frame+1])
    ...
    axs[0,1].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[0,1].set_ylim([np.min(longo_NMSE[frame-window:frame+1]), np.max(longo_NMSE[frame-window:frame+1])])
    axs[0,2].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[0,2].set_ylim([np.min(longo_chi_square[frame-window:frame+1]), np.max(longo_chi_square[frame-window:frame+1])])
    ...
    zurich_nmse.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    zurich_nmse.set_ydata(zurich_NMSE[:frame + 1])
    zurich_chi.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    ...
    axs[1, 1].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[1, 1].set_ylim([np.min(zurich_NMSE[frame-window:frame + 1]), np.max(zurich_NMSE[frame-window:frame + 1])])
    axs[1, 2].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[1, 2].set_ylim([np.min(zurich_chi_square[frame-window:frame + 1]), np.max(zurich_chi_square[frame-window:frame + 1])])
    ...
    zhang_nmse.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    zhang_nmse.set_ydata(zhang_NMSE[:frame + 1])
    zhang_chi.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    ...
    axs[2, 1].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[2, 1].set_ylim([np.min(zhang_NMSE[frame-window:frame + 1]), np.max(zhang_NMSE[frame-window:frame + 1])])
    axs[2, 2].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[2, 2].set_ylim([np.min(zhang_chi_square[frame-window:frame + 1]), np.max(zhang_chi_square[frame-window:frame + 1])])
    ...
    yang_nmse.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    yang_nmse.set_ydata(yang_NMSE[:frame + 1])
    yang_chi.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    ...
    axs[3, 1].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[3, 1].set_ylim([np.min(yang_NMSE[frame-window:frame + 1]), np.max(yang_NMSE[frame-window:frame + 1])])
    axs[3, 2].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[3, 2].set_ylim([np.min(yang_chi_square[frame-window:frame + 1]), np.max(yang_chi_square[frame-window:frame + 1])])
    ...
    fouquet_nmse.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    fouquet_nmse.set_ydata(fouquet_NMSE[:frame + 1])
    fouquet_chi.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    ...
    axs[4, 1].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[4, 1].set_ylim([np.min(fouquet_NMSE[frame-window:frame + 1]), np.max(fouquet_NMSE[frame-window:frame + 1])])
    axs[4, 2].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[4, 2].set_ylim([np.min(fouquet_chi_square[frame-window:frame + 1]), np.max(fouquet_chi_square[frame-window:frame + 1])])
    ...
    awayssa_nmse.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    awayssa_nmse.set_ydata(awayssa_NMSE[:frame + 1])
    awayssa_chi.set_xdata(spec_ice_obj.human_timestamps[:frame + 1])
    ...
    axs[5, 1].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[5, 1].set_ylim([np.min(awayssa_NMSE[frame-window:frame + 1]), np.max(awayssa_NMSE[frame-window:frame + 1])])
    axs[5, 2].set_xlim([spec_ice_obj.human_timestamps[frame-window], spec_ice_obj.human_timestamps[frame]])
    axs[5, 2].set_ylim([np.min(awayssa_chi_square[frame-window:frame + 1]), np.max(awayssa_chi_square[frame-window:frame + 1])])
