...
spec_air_obj = file_csv.read('../data/testICE_10_12_25/c0.csv', 3, "spectrum", aggregate=np.mean)
spec_ice_obj = file_csv.read('../data/testICE_10_12_25/cice.csv', 3, "spectrum", aggregate=np.mean)
