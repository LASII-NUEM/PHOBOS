...
init_guess_DLS = np.array([1, 1, 1, 1, 1, 1, 0.5, 1])
scaling_array_DLS  = np.array([1e4, 1e-7, 1e6, 1e-2, 1e4, 1e-1, 1, 1])
...
fit_obj = fitting_utils.EquivalentCircuit("Longo2020", spec_obj, spec_obj.freqs) #equivalent circuit object
