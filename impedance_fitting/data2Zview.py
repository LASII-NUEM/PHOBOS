...
def savecsv(a, b, c,filename, folder, header=("Freq (Hz)","Z(real)","Z(imag)")):
...
savecsv(IA_freqs,IA_tap_z_real, IA_tap_z_imag, filename = "IA_tap", folder = folderZview_IA)
savecsv(IA_freqs,IA_mineral_z_real, IA_mineral_z_imag, filename = "IA_mineral", folder = folderZview_IA)
savecsv(IA_freqs,IA_distilled_z_real, IA_distilled_z_imag, filename = "IA_distilled", folder = folderZview_IA)
savecsv(IA_freqs,IA_deionized_z_real, IA_deionized_z_imag, filename = "IA_deionized", folder = folderZview_IA)
...
savecsv(LCR_freqs,LCR_tap_z_real, LCR_tap_z_imag, filename = "LCR_tap", folder = folderZview_LCR)
